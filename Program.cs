...
using SpaceWalk.Data.Implementations;
...
builder.Services.AddDbContext<DbContextClass>(opt => opt.UseNpgsql("Host=localhost;Port=5432;Database=forumspace;Username=postgres;Password=postgres"));
